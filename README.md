...
`location` is included inside the `location` block, and is a good place to add something like CORS headers for static font files. It is a good place to change a setting like `client_max_body_size`.
